...
To run this in a local environment run the following. 
...
''' install these packages before you run the program 
...
# Basic addition of two numbers using gradio
...
# demo.launch(server_name="127.0.0.1", server_port= 7860)
demo1.launch(server_name="127.0.0.1", server_port= 7860)
